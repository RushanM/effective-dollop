...
<div align="center">
    <img title="В будущем заменю эту картинку" src="https://github.com/RushanM/Minecraft-Mods-Russian-Translation/blob/beta/Ассеты/preview2.png?raw=true">
    <br>
    <br>
    <img title="Никак не связано с «Фаргус Мультимедия». Это просто добрая отсылка. Я работаю над переводами один с 2020 года, лишь изредка получая помощь от народа (хотелось бы, конечно, больше вклада от Интернета, но имеем, что имеем)." src="https://github.com/RushanM/Minecraft-Mods-Russian-Translation/blob/beta/Ассеты/fargus_cozy_vector.svg?raw=true" height="55">
    <a href="https://modrinth.com/mod/dynamicpack"><img title="Хороший мод, хороший разработчик ❤️" src="https://github.com/RushanM/Minecraft-Mods-Russian-Translation/blob/beta/Ассеты/dynamicpack_cozy_vector.svg?raw=true" height="55"></a>
    <a href="https://modrinth.com/mod/better-resource-pack-sorting"><img title="Очень удобный мод" src="https://github.com/RushanM/Minecraft-Mods-Russian-Translation/blob/beta/Ассеты/brps_cozy_vector.svg?raw=true" height="55"></a>
    <br>
    <br>
    <!--<a href="https://github.com/RushanM/Minecraft-Mods-Russian-Translation/wiki/%D0%9F%D0%BE%D0%BC%D0%BE%D1%89%D1%8C-%D1%81-%D0%BF%D0%B5%D1%80%D0%B5%D0%B2%D0%BE%D0%B4%D0%BE%D0%BC">
        <img height="38" src="https://github.com/RushanM/Minecraft-Mods-Russian-Translation/blob/beta/Ассеты/translate.svg">
    </a>-->
</div>
...
Это набор ресурсов, разрабатываемый для версий Minecraft от 1.6.x до 1.21.x, затрагивающий перевод модов, сделанных под загрузчики Forge, Fabric, Quilt и NeoForge.

Помимо русского языка в наборе планируются переводы и на остальные восточнославянские и поволжские тюркские языки. Например, в определённых версиях этого набора уже включены переводы некоторых модов на татарский и белорусский языки.
...
<a href="https://www.curseforge.com/minecraft/texture-packs/mods-ru">
    <img height="35" src="https://github.com/RushanM/Minecraft-Mods-Russian-Translation/blob/beta/Ассеты/curseforge_compact_vector.svg?raw=true">
...
Версии набора ресурсов именуются согласно своей, но знакомой системе версий. Вот пара примеров:

* 1.21-1.1 — это релиз 1.1 для Minecraft 1.21.x,
* 1.21-1.1-B6 — это 6-я бета релиза 1.1 для Minecraft 1.21.x,
* 1.20-1.4 — это релиз 1.4 для Minecraft 1.20.x,
* 1.21-1.0-C1-B1-A300  — это 300-я альфа 1-й беты 1-го кандидата на релиз 1.0 для Minecraft 1.21.x.

Таким образом запись 1.0 соответствует номеру релизной версии. Запись с буквой B — бета-версии, запись с буквой A — альфа-версии. Если в конце номера версии стоит A и какое-то число, эта версия является альфой. Точно так же если в конце просто стоит 1.0 без буквенного обозначения, то эта версия является релизной.
